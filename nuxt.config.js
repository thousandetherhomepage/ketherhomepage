...
export default {
  ...
  render: {
    ...
    csp: {
      ...
      policies: {
        ...
        'connect-src': ["'self'", 'https://ethereum-rpc.publicnode.com', 'https://eth.drpc.org', '*.infura.io', '*.walletconnect.com', 'wss://*.walletconnect.com'],
  ...
  head: {
    ...
    meta: [
      ...
      process.env.NODE_ENV === 'production' ? { 'http-equiv': "Content-Security-Policy", content: "upgrade-insecure-requests; default-src 'self'; script-src 'self' 'self' *.infura.io; connect-src 'self' https://ethereum-rpc.publicnode.com https://eth.drpc.org *.infura.io *.walletconnect.com wss://*.walletconnect.com; style-src 'self' 'unsafe-inline'; img-src * data:; frame-src 'self' '*.walletconnect.com'"} : {},
